...
public class TestDecimalRoundingSuite extends RegressionSuite {
    ...
    public void testDecimalScaleInsertion() throws Exception {
        doTestDecimalScaleInsertion(true, RoundingMode.HALF_UP);
        doTestDecimalScaleInsertion(false, RoundingMode.HALF_UP);
        doTestDecimalScaleInsertion(false, RoundingMode.HALF_DOWN);
    }

    public void notestDecimalScaleInsertion() throws Exception {
    ...
    private static final BigDecimal roundDecimalValue(String  decimalValueString,
        ...
        assertEquals(m_defaultScale, nbd.scale());
        return nbd;
    }

    private void doTestDecimalScaleInsertion(boolean roundingEnabled,
                                             RoundingMode mode) throws Exception {
        VoltDecimalHelper.enabled = roundingEnabled;
        VoltDecimalHelper.mode = mode;
        ...
        validateDecimalQuery(roundingEnabled,
                             ...
                             "select dec from decimaltable where dec = 9.9999999999999999;",
                             "truncate table decimaltable;",
                             roundDecimalValue("10.000000000000", roundingEnabled, mode)
                             );
        if (roundingEnabled) {
            //
    ...
    private static void addConfig(MultiConfigSuiteBuilder builder, VoltProjectBuilder project, Map<String, String> properties) {
    ...
    static public junit.framework.Test suite() {
        ...
        addConfig(builder, project, makePropertiesMap());
        // addConfig(builder, project, makePropertiesMap(m_roundingEnabledProperty, "false"));
        // addConfig(builder, project, makePropertiesMap(m_roundingEnabledProperty, "true"));
        // addConfig(builder, project, makePropertiesMap(m_roundingEnabledProperty, "true", m_roundingModeProperty, "HALF_UP"));
        // addConfig(builder, project, makePropertiesMap(m_roundingEnabledProperty, "true", m_roundingModeProperty, "HALF_DOWN"));
        // addConfig(builder, project, makePropertiesMap(m_roundingEnabledProperty, "true", m_roundingModeProperty, "CEILING"));
        // addConfig(builder, project, makePropertiesMap(m_roundingEnabledProperty, "true", m_roundingModeProperty, "FLOOR"));
        // addConfig(builder, project, makePropertiesMap(m_roundingEnabledProperty, "true", m_roundingModeProperty, "UP"));
        // addConfig(builder, project, makePropertiesMap(m_roundingEnabledProperty, "true", m_roundingModeProperty, "DOWN"));
        return builder;
    }
}
